#!/bin/bash
# Complete workflow example for KITS classifier with feature caching

echo "=========================================="
echo "KITS Classifier - Complete Workflow"
echo "=========================================="
...
python3 -m kits_classifier.extract_features_script \
...
python3 -m kits_classifier.main train \
...
python3 -m kits_classifier.main eval \
