...
Bundles were trained and tested via 10-fold cross-validation on 2854 CT lesions from 1279 patients (in-house & KiTS).
We particular recommend the tool for cysts classification, `radiomics_binary`! All bundles are for research use only.
...
Classes:
```python
{0: "ccRCC", 1: "pRCC", 2: "chrRCC", 3: "Oncocytoma", 4: "Cyst", 5: "Other"}
```
- identifier: **RADIOMICS**
<div align="center">
  <img src="radiomics/cv_confusion_matrix.webp" alt="Description of Image 1" width="30%">
...
- identifier: **FMCIB**
<div align="center">
  <img src="fmcib/cv_confusion_matrix.webp" alt="Description of Image 1" width="30%">
