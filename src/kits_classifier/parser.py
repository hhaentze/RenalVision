...
def create_parser():
    ...
    train_parser.add_argument(
        "--model", type=str, choices=["logistic", "tree"], required=True,
    ...
    train_parser.add_argument(
        "--tree-depth", type=int, default=5,
        help="Max depth for decision tree (default: 5)"
    )
    ...
    infer_parser.add_argument(
        ...
        help="Path to CT image (.nii.gz)"
    )
    infer_parser.add_argument(
        "--seg", type=str, required=True,
        help="Path to segmentation mask (.nii.gz)"
    )
    infer_parser.add_argument(
    ...
    infer_parser.add_argument(
        "--multi-lesion", action="store_true",
    ...
    infer_parser.add_argument(
        "--no-label-mapping", action="store_true",
