...
from .models import train_model, predict, predict_proba, ModelBundle, compute_feature_correlations
from .utils import compute_metrics, plot_roc_curve, plot_confusion_matrix, print_metrics_report, get_all_lesion_components
...
def infer_mode(args):
    ...
    print(f"Loading image and segmentation...")
    image, seg, affine = load_and_preprocess(
        args.image,
        args.seg,
        map_labels=not args.no_label_mapping
    )
